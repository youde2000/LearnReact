  ...
  "node_modules/react-quill/dist/react-quill.js"(exports, module) {
    !function(t, e) {
      ...
      return function(t2) {
        ...
        var r = n(11);
        t2.exports = function(t3, e3) {
          for (var n2 = t3.length; n2--; ) if (r(t3[n2][0], e3)) return n2;
          return -1;
        };
      }, function(t2, e2, n) {
        ...
        t2.exports = function(t3, e3, n2, s, u, c) {
          ...
          if (d && y) return d == e3 && y == t3;
          var v = -1, b = true, g = n2 & a ? new r() : void 0;
          for (c.set(t3, e3), c.set(e3, t3); ++v < h; ) {
            var m = t3[v], _ = e3[v];
            if (s) var O = f ? s(_, m, v, e3, t3, c) : s(m, _, v, t3, e3, c);
            if (void 0 !== O) {
              if (O) continue;
              b = false;
              break;
            ...
            if (g) {
              if (!o(e3, function(t4, e4) {
                if (!i(g, e4) && (m === t4 || u(m, t4, n2, s, c))) return g.push(e4);
              })) {
                b = false;
                break;
              }
        ...
        var r, o = this && this.__extends || (r = function(t3, e3) {
          ...
          for (var t3 = 0, e3 = 0, n2 = arguments.length; e3 < n2; e3++) t3 += arguments[e3].length;
          var r2 = Array(t3), o2 = 0;
          for (e3 = 0; e3 < n2; e3++) for (var i2 = arguments[e3], l2 = 0, a2 = i2.length; l2 < a2; l2++, o2++) r2[o2] = i2[l2];
          return r2;
          ...
          return o(e3, t3), e3.prototype.validateProps = function(t4) {
            var e4;
            if (s.default.Children.count(t4.children) > 1) throw new Error("The Quill editing area can only be composed of a single React element.");
            if (s.default.Children.count(t4.children) && "textarea" === (null === (e4 = s.default.Children.only(t4.children)) || void 0 === e4 ? void 0 : e4.type)) throw new Error("Quill does not support editing on a <textarea>. Use a <div> instead.");
            if (this.lastDeltaChangeSet && t4.value === this.lastDeltaChangeSet) throw new Error("You are passing the `delta` object from the `onChange` event back as `value`. You most probably want `editor.getContents()` instead. See: https://github.com/zenoamaro/react-quill#using-deltas");
          }, e3.prototype.shouldComponentUpdate = function(t4, e4) {
            var n2, r2 = this;
            if (this.validateProps(t4), !this.editor || this.state.generation !== e4.generation) return true;
            if ("value" in t4) {
            ...
            if (!t4) throw new Error("Cannot find element for editing area");
            if (3 === t4.nodeType) throw new Error("Editing area cannot be a text node");
            return t4;
        ...
        t2.exports = function(t3, e3, n2, v, b, g) {
          ...
          if (k && !x) return g || (g = new r()), m || c(t3) ? o(t3, e3, n2, v, b, g) : i(t3, e3, O, n2, v, b, g);
          if (!(n2 & f)) {
        ...
        t2.exports = function(t3, e3) {
          ...
          if (n2 instanceof r) {
            var a = n2.__data__;
            if (!o || a.length < l - 1) return a.push([t3, e3]), this.size = ++n2.size, this;
        ...
        function l(t3) {
          var e3 = -1, n2 = null == t3 ? 0 : t3.length;
          for (this.__data__ = new r(); ++e3 < n2; ) this.add(t3[e3]);
        }
        ...
        t2.exports = function(t3, e3) {
          for (var n = -1, r = null == t3 ? 0 : t3.length; ++n < r; ) if (e3(t3[n], n, t3)) return true;
          return false;
        };
      }, function(t2, e2) {
        t2.exports = function(t3, e3) {
        ...
        t2.exports = function(t3, e3, n2, r2, w2, E, k) {
          switch (n2) {
            ...
            case b:
              var j = r2 & u;
              if (A || (A = s), t3.size != e3.size && !j) return false;
              var N = k.get(t3);
              if (N) return N == e3;
              r2 |= c, k.set(t3, e3);
            ...
            case m:
              if (x) return x.call(t3) == x.call(e3);
          }
          return false;
        };
      }, function(t2, e2, n) {
        ...
        t2.exports = function(t3, e3, n2, l, a, s) {
          ...
          if (f != r(e3).length && !u) return false;
          for (var h = f; h--; ) {
            var p = c[h];
            if (!(u ? p in e3 : i.call(e3, p))) return false;
          }
          ...
          for (var b = u; ++h < f; ) {
            ...
            if (l) var _ = u ? l(m, g, p, e3, t3, s) : l(g, m, p, t3, e3, s);
        ...
        t2.exports = function(t3, e3) {
          for (var n = -1, r = e3.length, o = t3.length; ++n < r; ) t3[o + n] = e3[n];
          return t3;
        };
      }, function(t2, e2, n) {
        ...
        t2.exports = function(t3, e3) {
          ...
          for (var v in t3) !e3 && !u.call(t3, v) || p && ("length" == v || f && ("offset" == v || "parent" == v) || h && ("buffer" == v || "byteLength" == v || "byteOffset" == v) || a(v, y)) || d.push(v);
          return d;
        };
      }, function(t2, e2) {
        t2.exports = function(t3, e3) {
          for (var n = -1, r = Array(t3); ++n < t3; ) r[n] = e3(n);
          return r;
        };
      }, function(t2, e2, n) {
        ...
        t2.exports = function(t3) {
          if (!r(t3)) return o(t3);
          var e3 = [];
          for (var n2 in Object(t3)) i.call(t3, n2) && "constructor" != n2 && e3.push(n2);
          return e3;
        };
      }, function(t2, e2) {
          ...
          "undefined" != typeof self && self, n2 = function() {
            return function(t3) {
              ...
              var r, o = this && this.__extends || (r = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(t4, e5) {
                ...
                for (var n4 in e5) e5.hasOwnProperty(n4) && (t4[n4] = e5[n4]);
              }, function(t4, e5) {
                function n4() {
                  this.constructor = t4;
                }
              ...
              function f(t4, e5) {
                var n4;
                if (void 0 === e5 && (e5 = l.ANY), "string" == typeof t4) n4 = c[t4] || a[t4];
                else if (t4 instanceof Text || t4.nodeType === Node.TEXT_NODE) n4 = c.text;
                else if ("number" == typeof t4) t4 & l.LEVEL & l.BLOCK ? n4 = c.block : t4 & l.LEVEL & l.INLINE && (n4 = c.inline);
                else if (t4 instanceof HTMLElement) {
                  var r2 = (t4.getAttribute("class") || "").split(/\s+/);
                  for (var o2 in r2) if (n4 = s[r2[o2]]) break;
                  n4 = n4 || u[t4.tagName];
                }
              ...
              e4.DATA_KEY = "__blot", function(t4) {
                ...
                var n4 = f(t4);
                if (null == n4) throw new i("Unable to create " + t4 + " blot");
                ...
                for (var e5 = [], n4 = 0; n4 < arguments.length; n4++) e5[n4] = arguments[n4];
                if (e5.length > 1) return e5.map(function(e6) {
                  return t4(e6);
                });
                var r2 = e5[0];
                if ("string" != typeof r2.blotName && "string" != typeof r2.attrName) throw new i("Invalid definition");
                if ("abstract" === r2.blotName) throw new i("Cannot register abstract class");
              ...
              s.prototype.insert = function(t4, e5) {
                ...
                if (t4 = i(true, {}, t4), "object" == typeof n4) {
                  if ("number" == typeof t4.delete && "number" == typeof n4.delete) return this.ops[e5 - 1] = { delete: n4.delete + t4.delete }, this;
                  if ("number" == typeof n4.delete && null != t4.insert && (e5 -= 1, "object" != typeof (n4 = this.ops[e5 - 1]))) return this.ops.unshift(t4), this;
                  if (o(t4.attributes, n4.attributes)) {
                    if ("string" == typeof t4.insert && "string" == typeof n4.insert) return this.ops[e5 - 1] = { insert: n4.insert + t4.insert }, "object" == typeof t4.attributes && (this.ops[e5 - 1].attributes = t4.attributes), this;
                    if ("number" == typeof t4.retain && "number" == typeof n4.retain) return this.ops[e5 - 1] = { retain: n4.retain + t4.retain }, "object" == typeof t4.attributes && (this.ops[e5 - 1].attributes = t4.attributes), this;
                  }
                }
                ...
                if (null != i2 && "number" == typeof i2.retain && null == i2.attributes) {
                  for (var a2 = i2.retain; "insert" === e5.peekType() && e5.peekLength() <= a2; ) a2 -= e5.peekLength(), r2.push(e5.next());
                  i2.retain - a2 > 0 && n4.next(i2.retain - a2);
                }
                for (var u = new s(r2); e5.hasNext() || n4.hasNext(); ) if ("insert" === n4.peekType()) u.push(n4.next());
                else if ("delete" === e5.peekType()) u.push(e5.next());
                else {
                ...
                if (this.ops === t4.ops) return new s();
                var n4 = [this, t4].map(function(e6) {
                  return e6.map(function(n5) {
                    if (null != n5.insert) return "string" == typeof n5.insert ? n5.insert : a;
                ...
                for (var n4 = l.iterator(this.ops), r2 = new s(), o2 = 0; n4.hasNext(); ) {
                  if ("insert" !== n4.peekType()) return;
                  var i2 = n4.peek(), a2 = l.length(i2) - n4.peekLength(), u = "string" == typeof i2.insert ? i2.insert.indexOf(e5, a2) - a2 : -1;
                  if (u < 0) r2.push(n4.next());
                  else if (u > 0) r2.push(n4.next(u));
                  else {
                    if (false === t4(r2, n4.next(1).attributes || {}, o2)) return;
                    o2 += 1, r2 = new s();
                  }
                }
                r2.length() > 0 && t4(r2, {}, o2);
              }, s.prototype.transform = function(t4, e5) {
                if (e5 = !!e5, "number" == typeof t4) return this.transformPosition(t4, e5);
                for (var n4 = l.iterator(this.ops), r2 = l.iterator(t4.ops), o2 = new s(); n4.hasNext() || r2.hasNext(); ) if ("insert" !== n4.peekType() || !e5 && "insert" === r2.peekType()) if ("insert" === r2.peekType()) o2.push(r2.next());
                else {
                ...
                else o2.retain(l.length(n4.next()));
                return o2.chop();
              ...
              var n3 = Object.prototype.hasOwnProperty, r = Object.prototype.toString, o = Object.defineProperty, i = Object.getOwnPropertyDescriptor, l = function(t4) {
                ...
                if (!t4 || "[object Object]" !== r.call(t4)) return false;
                ...
                if (t4.constructor && !o2 && !i2) return false;
                for (e5 in t4) ;
                ...
                if ("__proto__" === e5) {
                  if (!n3.call(t4, e5)) return;
                  if (i) return i(t4, e5).value;
                }
                return t4[e5];
              };
              t3.exports = function t4() {
                var e5, n4, r2, o2, i2, c, f = arguments[0], h = 1, p = arguments.length, d = false;
                for ("boolean" == typeof f && (d = f, f = arguments[1] || {}, h = 2), (null == f || "object" != typeof f && "function" != typeof f) && (f = {}); h < p; ++h) if (null != (e5 = arguments[h])) for (n4 in e5) r2 = u(f, n4), f !== (o2 = u(e5, n4)) && (d && o2 && (a(o2) || (i2 = l(o2))) ? (i2 ? (i2 = false, c = r2 && l(r2) ? r2 : []) : c = r2 && a(r2) ? r2 : {}, s(f, { name: n4, newValue: t4(d, c, o2) })) : void 0 !== o2 && s(f, { name: n4, newValue: o2 }));
                return f;
              };
            }, function(t3, e4, n3) {
              "use strict";
              ...
              function d(t4, e5) {
                if ("function" != typeof e5 && null !== e5) throw new TypeError("Super expression must either be null or a function, not " + typeof e5);
              ...
              var y = function(t4) {
                ...
                return d(e5, t4), r(e5, [{ key: "attach", value: function() {
                  ...
                  } else o(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "insertAt", this).call(this, t5, n4, r2);
                } }]), e5;
              }(a.default.Embed);
              ...
              var v = function(t4) {
                ...
                return d(e5, t4), r(e5, [{ key: "delta", value: function() {
                  ...
                  if (null != r2) return o(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "insertAt", this).call(this, t5, n4, r2);
                  if (0 !== n4.length) {
                    var i2 = n4.split("\n"), l2 = i2.shift();
              ...
              var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t4) {
                ...
                if (Symbol.iterator in Object(t4)) return function(t5, e6) {
              ...
              var g = (0, d.default)("quill"), m = function() {
                function t4(e5) {
                  ...
                  }(this, t4), this.options = _(e5, r2), this.container = this.options.container, null == this.container) return g.error("Invalid Quill container", e5);
                ...
                return i(t4, null, [{ key: "debug", value: function(t5) {
                  ...
                  } else null == this.imports[t5] || r2 || g.warn("Overwriting " + t5 + " with", e5), this.imports[t5] = e5, (t5.startsWith("blots/") || t5.startsWith("formats/")) && "abstract" !== e5.blotName ? c.default.register(e5) : t5.startsWith("modules") && "function" == typeof e5.register && e5.register();
                  ...
                  return O.call(this, function() {
                    ...
                    if (c.default.query(t5, c.default.Scope.BLOCK)) o2 = n4.editor.formatLine(r3.index, r3.length, b({}, t5, e5));
                    else {
                      if (0 === r3.length) return n4.selection.format(t5, e5), o2;
                  ...
                  if (null == e5) this.selection.setRange(null, n4 || t4.sources.API);
                  else {
              ...
              function _(t4, e5) {
                if ((e5 = (0, p.default)(true, { container: t4, modules: { clipboard: true, keyboard: true, history: true } }, e5)).theme && e5.theme !== m.DEFAULTS.theme) {
                  if (e5.theme = m.import("themes/" + e5.theme), null == e5.theme) throw new Error("Invalid theme " + e5.theme + ". Did you register it?");
                } else e5.theme = y.default;
              ...
              function O(t4, e5, n4, r2) {
                if (this.options.strict && !this.isEnabled() && e5 === s.default.sources.USER) return new l.default();
              ...
              var s = function(t4) {
                ...
                return function(t5, e6) {
                  if ("function" != typeof e6 && null !== e6) throw new TypeError("Super expression must either be null or a function, not " + typeof e6);
                  ...
                  if (e5.compare(this.statics.blotName, r2) < 0 && l.default.query(r2, l.default.Scope.BLOT)) {
                    ...
                    i2 && a2.wrap(r2, i2);
                  } else o(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "formatAt", this).call(this, t5, n4, r2, i2);
                } }, { key: "optimize", value: function(t5) {
              ...
              ["selectionchange", "mousedown", "mouseup", "click"].forEach(function(t4) {
                document.addEventListener(t4, function() {
                  for (var t5 = arguments.length, e5 = Array(t5), n4 = 0; n4 < t5; n4++) e5[n4] = arguments[n4];
              ...
              var s = function(t4) {
                function e5() {
                  ...
                  var t5 = function(t6, e6) {
                    if (!t6) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                ...
                return function(t5, e6) {
                  ...
                  for (var e6 = arguments.length, n4 = Array(e6 > 1 ? e6 - 1 : 0), r2 = 1; r2 < e6; r2++) n4[r2 - 1] = arguments[r2];
              ...
              function i(t4) {
                if (r.indexOf(t4) <= r.indexOf(o)) {
                  for (var e5, n4 = arguments.length, i2 = Array(n4 > 1 ? n4 - 1 : 0), l2 = 1; l2 < n4; l2++) i2[l2 - 1] = arguments[l2];
              ...
              var r = Array.prototype.slice, o = n3(52), i = n3(53), l = t3.exports = function(t4, e5, n4) {
                return n4 || (n4 = {}), t4 === e5 || (t4 instanceof Date && e5 instanceof Date ? t4.getTime() === e5.getTime() : !t4 || !e5 || "object" != typeof t4 && "object" != typeof e5 ? n4.strict ? t4 === e5 : t4 == e5 : function(t5, e6, n5) {
                  var u, c;
                  if (a(t5) || a(e6)) return false;
                  if (t5.prototype !== e6.prototype) return false;
                  if (i(t5)) return !!i(e6) && (t5 = r.call(t5), e6 = r.call(e6), l(t5, e6, n5));
                  if (s(t5)) {
                    if (!s(e6)) return false;
                    if (t5.length !== e6.length) return false;
                    for (u = 0; u < t5.length; u++) if (t5[u] !== e6[u]) return false;
                    return true;
                  }
                  try {
                    var f = o(t5), h = o(e6);
                  ...
                  for (u = f.length - 1; u >= 0; u--) if (c = f[u], !l(t5[c], e6[c], n5)) return false;
              ...
              var v = function(t4) {
                ...
                return d(e5, t4), o(e5, [{ key: "delta", value: function() {
                  ...
                  if (e6) return this.domNode.textContent.slice(0, t5).lastIndexOf("\n");
              ...
              var g = /^[ -~]*$/, m = function() {
                ...
                return i(t4, [{ key: "applyDelta", value: function(t5) {
                  ...
                  } else this.delta = this.getDelta(), t5 && (0, y.default)(r2.compose(t5), this.delta) || (t5 = r2.diff(this.delta, n4));
                  return t5;
                } }]), t4;
              }();
              function _(t4, e5) {
              ...
              function c(t4) {
                if (Array.isArray(t4)) {
                  for (var e5 = 0, n4 = Array(t4.length); e5 < t4.length; e5++) n4[e5] = t4[e5];
                  return n4;
                }
              ...
              var h = (0, u(n3(10)).default)("quill:selection"), p = function t4(e5) {
                ...
                return o(t4, [{ key: "handleComposition", value: function() {
                  ...
                  if (null == this.scroll.whitelist || this.scroll.whitelist[t5]) {
                    ...
                    if (null != n4 && n4.native.collapsed && !i.default.query(t5, i.default.Scope.BLOCK)) {
                      if (n4.start.node !== this.cursor.textNode) {
                        ...
                        } else r2.insertBefore(this.cursor, n4.start.node);
                        this.cursor.attach();
                      }
                  ...
                  if (e5 > 0) {
                    ...
                    if (a2 = p2[0], s2 = p2[1], null == a2) return null;
                  ...
                  if (null == t5 || t5.rangeCount <= 0) return null;
                  ...
                  if (!y(this.root, t5.startContainer) || !t5.collapsed && !y(this.root, t5.endContainer)) return null;
                  ...
                  return [e5.start, e5.end].forEach(function(t6) {
                    for (var e6 = t6.node, n4 = t6.offset; !(e6 instanceof Text) && e6.childNodes.length > 0; ) if (e6.childNodes.length > n4) e6 = e6.childNodes[n4], n4 = 0;
                    else {
                      if (e6.childNodes.length !== n4) break;
                ...
                return o(e5, t4), e5.prototype.appendChild = function(t5) {
                  ...
                  this.children = new i.default(), [].slice.call(this.domNode.childNodes).reverse().forEach(function(e6) {
                    try {
                      ...
                      if (t6 instanceof a.ParchmentError) return;
                      throw t6;
                    }
                  });
                }, e5.prototype.deleteAt = function(t5, e6) {
                  if (0 === t5 && e6 === this.length()) return this.remove();
                  ...
                  if (t4.prototype.optimize.call(this, e6), 0 === this.children.length) if (null != this.statics.defaultChild) {
                  ...
                  if (void 0 === e6 && (e6 = false), !e6) {
                    if (0 === t5) return this;
                    if (t5 === this.length()) return this.next;
                  }
                  var n4 = this.clone();
              ...
              var r = n3(11), o = n3(3), i = { attributes: { compose: function(t4, e5, n4) {
                ...
                }, {})), t4) void 0 !== t4[i2] && void 0 === e5[i2] && (r2[i2] = t4[i2]);
              ...
              l.prototype.hasNext = function() {
                ...
                if (e5) {
                  ...
                  if (t4 >= r2 - n4 ? (t4 = r2 - n4, this.index += 1, this.offset = 0) : this.offset += t4, "number" == typeof e5.delete) return { delete: t4 };
                  var o2 = {};
              ...
              var r = function() {
                ...
                function i(l2, s, u, c, f) {
                  ...
                  return void 0 === s && (s = true), void 0 === u && (u = 1 / 0), function l3(u2, y) {
                    ...
                    if (0 === y) return u2;
                    var v, b;
                    if ("object" != typeof u2) return u2;
                    if (t4(u2, n4)) v = new n4();
                    else if (t4(u2, r2)) v = new r2();
                    else if (t4(u2, o)) v = new o(function(t5, e4) {
                      u2.then(function(e5) {
                        t5(l3(e5, y - 1));
                      }, function(t6) {
                        e4(l3(t6, y - 1));
                    ...
                    else if (i.__isArray(u2)) v = [];
                    else if (i.__isRegExp(u2)) v = new RegExp(u2.source, a(u2)), u2.lastIndex && (v.lastIndex = u2.lastIndex);
                    else if (i.__isDate(u2)) v = new Date(u2.getTime());
                    else {
                      if (d && e3.isBuffer(u2)) return v = e3.allocUnsafe ? e3.allocUnsafe(u2.length) : new e3(u2.length), u2.copy(v), v;
              ...
              var y = function(t4) {
                ...
                return function(t5, e6) {
                  ...
                  if (i(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "deleteAt", this).call(this, t5, n4), null != p2 && a2 !== p2 && u2 > 0) {
                    if (a2 instanceof s.BlockEmbed || p2 instanceof s.BlockEmbed) return void this.optimize();
                    if (a2 instanceof f.default) {
                      var d2 = a2.newlineIndex(a2.length(), true);
                      if (d2 > -1 && (a2 = a2.split(d2 + 1)) === p2) return void this.optimize();
                  ...
                  if (null == r2 || null == this.whitelist || this.whitelist[n4]) {
                    if (t5 >= this.length()) if (null == r2 || null == l.default.query(n4, l.default.Scope.BLOCK)) {
                    ...
                    else i(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "insertAt", this).call(this, t5, n4, r2);
                    this.optimize();
                  }
                } }, { key: "insertBefore", value: function(t5, n4) {
                    ...
                    if (!n4.defaultPrevented) {
                      ...
                      if (0 !== l2.length) {
                        ...
                        if (null != s2 && t5.quill.hasFocus()) {
                          ...
                          l2.some(function(e6) {
                            if (null != e6.collapsed && e6.collapsed !== E2.collapsed) return false;
                            if (null != e6.empty && e6.empty !== E2.empty) return false;
                            if (null != e6.offset && e6.offset !== E2.offset) return false;
              ...
              function j(t4) {
                if ("string" == typeof t4 || "number" == typeof t4) return j({ key: t4 });
                if ("object" === (void 0 === t4 ? "undefined" : r(t4)) && (t4 = (0, l.default)(t4, false)), "string" == typeof t4.key) if (null != m.keys[t4.key.toUpperCase()]) t4.key = m.keys[t4.key.toUpperCase()];
                else {
                  if (1 !== t4.key.length) return null;
              ...
              m.keys = { BACKSPACE: 8, TAB: 9, ENTER: 13, ESCAPE: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, DELETE: 46 }, m.DEFAULTS = { bindings: { bold: A("bold"), italic: A("italic"), underline: A("underline"), indent: { key: m.keys.TAB, format: ["blockquote", "indent", "list"], handler: function(t4, e5) {
                if (e5.collapsed && 0 !== e5.offset) return true;
              ...
              var u = function(t4) {
                ...
                return function(t5, e6) {
                  ...
                  if (0 !== this._length) return o(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "format", this).call(this, t5, n4);
                  for (var r2 = this, i2 = 0; null != r2 && r2.statics.scope !== l.default.Scope.BLOCK_BLOT; ) i2 += r2.offset(r2.parent), r2 = r2.parent;
              ...
              var r, o = /* @__PURE__ */ function() {
                ...
                return function(t5, e6) {
                  ...
                  if (t5 !== this.statics.blotName || !n4) return i(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "format", this).call(this, t5, n4);
              ...
              var r = n3(1), o = function() {
                ...
                return Object.defineProperty(t4.prototype, "statics", { get: function() {
                  ...
                  if (null != r.query(n4, r.Scope.BLOT) && o2) i.wrap(n4, o2);
              ...
              var a = "\uFEFF", s = function(t4) {
                ...
                return function(t5, e6) {
                  ...
                  if (t5 === this.leftGuard) if (this.prev instanceof i.default) {
                    var l2 = this.prev.length();
                    this.prev.insertAt(l2, r2), e6 = { startNode: this.prev.domNode, startOffset: l2 + r2.length };
                  } else n4 = document.createTextNode(r2), this.parent.insertBefore(o.default.create(n4), this), e6 = { startNode: n4, startOffset: r2.length };
                  else t5 === this.rightGuard && (this.next instanceof i.default ? (this.next.insertAt(0, r2), e6 = { startNode: this.next.domNode, startOffset: r2.length }) : (n4 = document.createTextNode(r2), this.parent.insertBefore(o.default.create(n4), this.next), e6 = { startNode: n4, startOffset: r2.length }));
                  return t5.data = a, e6;
                } }, { key: "update", value: function(t5, e6) {
                  var n4 = this;
                  t5.forEach(function(t6) {
              ...
              var b = [false, "center", "right", "justify"], g = ["#000000", "#e60000", "#ff9900", "#ffff00", "#008a00", "#0066cc", "#9933ff", "#ffffff", "#facccc", "#ffebcc", "#ffffcc", "#cce8cc", "#cce0f5", "#ebd6ff", "#bbbbbb", "#f06666", "#ffc266", "#ffff66", "#66b966", "#66a3e0", "#c285ff", "#888888", "#a10000", "#b26b00", "#b2b200", "#006100", "#0047b2", "#6b24b2", "#444444", "#5c0000", "#663d00", "#666600", "#003700", "#002966", "#3d1466"], m = [false, "serif", "monospace"], _ = ["1", "2", "3", false], O = ["small", false, "large", "huge"], w = function(t4) {
                function e5(t5, n4) {
                  ...
                  return t5.emitter.listenDOM("click", document.body, function e6(n5) {
                    if (!document.body.contains(t5.root)) return document.body.removeEventListener("click", e6);
                ...
                return v(e5, t4), r(e5, [{ key: "addModule", value: function(t5) {
                  ...
                  t5.forEach(function(t6) {
                    (t6.getAttribute("class") || "").split(/\s+/).forEach(function(n4) {
                      if (n4.startsWith("ql-") && (n4 = n4.slice("ql-".length), null != e6[n4])) if ("direction" === n4) t6.innerHTML = e6[n4][""] + e6[n4].rtl;
                      else if ("string" == typeof e6[n4]) t6.innerHTML = e6[n4];
                      else {
                        var r2 = t6.value || "";
                  ...
                  this.pickers = t5.map(function(t6) {
                    if (t6.classList.contains("ql-align")) return null == t6.querySelector("option") && E(t6, b), new c.default(t6, e6.align);
              ...
              var r = function() {
                ...
                return t4.prototype.append = function() {
                  ...
                  for (var e5, n4 = this.iterator(); e5 = n4(); ) if (e5 === t5) return true;
                  return false;
                  ...
                  for (var n4, r2 = this.iterator(); n4 = r2(); ) {
                    var o = n4.length();
                    if (t5 < o || e5 && t5 === o && (null == n4.next || 0 !== n4.next.length())) return [n4, t5];
                    t5 -= o;
                  }
                  return [null, 0];
                }, t4.prototype.forEach = function(t5) {
                  for (var e5, n4 = this.iterator(); e5 = n4(); ) t5(e5);
                }, t4.prototype.forEachAt = function(t5, e5, n4) {
                  if (!(e5 <= 0)) for (var r2, o = this.find(t5), i = o[0], l = t5 - o[1], a = this.iterator(i); (r2 = a()) && l < t5 + e5; ) {
                    var s = r2.length();
                  ...
                  for (var n4, r2 = this.iterator(); n4 = r2(); ) e5 = t5(e5, n4);
                  return e5;
                }, t4;
              }();
              e4.default = r;
              ...
              var i = n3(17), l = n3(1), a = { attributes: true, characterData: true, characterDataOldValue: true, childList: true, subtree: true }, s = function(t4) {
                ...
                return o(e5, t4), e5.prototype.detach = function() {
                  ...
                  for (var o2 = [].slice.call(this.observer.takeRecords()); o2.length > 0; ) e6.push(o2.pop());
                  for (var a2 = function(t5, e7) {
                    ...
                    }), this.children.forEach(s2), o2 = (u = [].slice.call(this.observer.takeRecords())).slice(); o2.length > 0; ) e6.push(o2.pop());
                  }
                }, e5.prototype.update = function(e6, n4) {
                  var r2 = this;
              ...
              var i = n3(18), l = n3(1), a = function(t4) {
                ...
                return o(e5, t4), e5.formats = function(n4) {
                  if (n4.tagName !== e5.tagName) return t4.formats.call(this, n4);
                  ...
                  o2 instanceof e5 && o2.prev === this && function(t5, e6) {
                    ...
                    for (var n5 in t5) if (t5[n5] !== e6[n5]) return false;
                    return true;
              ...
              var i = n3(18), l = n3(1), a = function(t4) {
                ...
                return o(e5, t4), e5.formats = function(n4) {
                  ...
                  if (n4.tagName !== r2) return t4.formats.call(this, n4);
                }, e5.prototype.format = function(n4, r2) {
                  ...
                  if (null == r2 || null != l.query(n4, l.Scope.INLINE)) t4.prototype.insertAt.call(this, e6, n4, r2);
                  else {
              ...
              String.prototype.startsWith || (String.prototype.startsWith = function(t4, e5) {
                ...
                for (var e5, n4 = Object(this), r2 = n4.length >>> 0, o2 = arguments[1], i = 0; i < r2; i++) if (e5 = n4[i], t4.call(o2, e5, i, n4)) return e5;
              ...
              function i(t4, e5, u2) {
                ...
                var p = t4.substring(t4.length - f), d = function(t5, e6) {
                  ...
                  if (-1 != h2) return u3 = [[r, c2.substring(0, h2)], [o, f2], [r, c2.substring(h2 + f2.length)]], t5.length > e6.length && (u3[0][0] = u3[2][0] = n3), u3;
                  if (1 == f2.length) return [[n3, t5], [r, e6]];
                  var p2 = function(t6, e7) {
                    var n4 = t6.length > e7.length ? t6 : e7, r2 = t6.length > e7.length ? e7 : t6;
                    if (n4.length < 4 || 2 * r2.length < n4.length) return null;
                  ...
                  return function(t6, e7) {
                    for (var o2 = t6.length, i2 = e7.length, a2 = Math.ceil((o2 + i2) / 2), s2 = a2, u4 = 2 * a2, c3 = new Array(u4), f3 = new Array(u4), h3 = 0; h3 < u4; h3++) c3[h3] = -1, f3[h3] = -1;
                    c3[s2 + 1] = 0, f3[s2 + 1] = 0;
                    for (var p3 = o2 - i2, d3 = p3 % 2 != 0, y2 = 0, v2 = 0, b2 = 0, g2 = 0, m2 = 0; m2 < a2; m2++) {
                      for (var _2 = -m2 + y2; _2 <= m2 - v2; _2 += 2) {
                        for (var O = s2 + _2, w = (j = _2 == -m2 || _2 != m2 && c3[O - 1] < c3[O + 1] ? c3[O + 1] : c3[O - 1] + 1) - _2; j < o2 && w < i2 && t6.charAt(j) == e7.charAt(w); ) j++, w++;
                        if (c3[O] = j, j > o2) v2 += 2;
                        else if (w > i2) y2 += 2;
                        else if (d3 && (k = s2 + p3 - _2) >= 0 && k < u4 && -1 != f3[k]) {
                          var x = o2 - f3[k];
                          if (j >= x) return l(t6, e7, j, w);
                        }
                      }
                      for (var E = -m2 + b2; E <= m2 - g2; E += 2) {
                        for (var k = s2 + E, A = (x = E == -m2 || E != m2 && f3[k - 1] < f3[k + 1] ? f3[k + 1] : f3[k - 1] + 1) - E; x < o2 && A < i2 && t6.charAt(o2 - x - 1) == e7.charAt(i2 - A - 1); ) x++, A++;
                        if (f3[k] = x, x > o2) g2 += 2;
                        else if (A > i2) b2 += 2;
                        else if (!d3 && (O = s2 + p3 - E) >= 0 && O < u4 && -1 != c3[O]) {
                          var j = c3[O];
                          if (w = s2 + j - O, j >= (x = o2 - x)) return l(t6, e7, j, w);
                        }
                      }
                    }
                    return [[n3, t6], [r, e7]];
                ...
                return h && d.unshift([o, h]), p && d.push([o, p]), function t5(e6) {
                  e6.push([o, ""]);
                  for (var i2, l2 = 0, u3 = 0, c2 = 0, f2 = "", h2 = ""; l2 < e6.length; ) switch (e6[l2][0]) {
                    case r:
                      c2++, h2 += e6[l2][1], l2++;
                      break;
                    case n3:
                  ...
                  var p2 = false;
                  for (l2 = 1; l2 < e6.length - 1; ) e6[l2 - 1][0] == o && e6[l2 + 1][0] == o && (e6[l2][1].substring(e6[l2][1].length - e6[l2 - 1][1].length) == e6[l2 - 1][1] ? (e6[l2][1] = e6[l2 - 1][1] + e6[l2][1].substring(0, e6[l2][1].length - e6[l2 - 1][1].length), e6[l2 + 1][1] = e6[l2 - 1][1] + e6[l2 + 1][1], e6.splice(l2 - 1, 1), p2 = true) : e6[l2][1].substring(0, e6[l2 + 1][1].length) == e6[l2 + 1][1] && (e6[l2 - 1][1] += e6[l2 + 1][1], e6[l2][1] = e6[l2][1].substring(e6[l2 + 1][1].length) + e6[l2 + 1][1], e6.splice(l2 + 1, 1), p2 = true)), l2++;
                  p2 && t5(e6);
                  ...
                  if (a2[0] !== o) return t5;
                  if (null != s2 && a2[1] + s2[1] === s2[1] + a2[1]) return i2.splice(l2, 2, s2, a2), c(i2, l2, 2);
                  ...
                  }, l2 = 2; l2 < t5.length; l2 += 1) t5[l2 - 2][0] === o && (a2 = t5[l2 - 2][1]).charCodeAt(a2.length - 1) >= 55296 && a2.charCodeAt(a2.length - 1) <= 56319 && t5[l2 - 1][0] === n3 && i2(t5[l2 - 1][1]) && t5[l2][0] === r && i2(t5[l2][1]) && (e6 = true, t5[l2 - 1][1] = t5[l2 - 2][1].slice(-1) + t5[l2 - 1][1], t5[l2][1] = t5[l2 - 2][1].slice(-1) + t5[l2][1], t5[l2 - 2][1] = t5[l2 - 2][1].slice(0, -1));
                  var a2;
                  if (!e6) return t5;
                  var s2 = [];
                  for (l2 = 0; l2 < t5.length; l2 += 1) t5[l2][1].length > 0 && s2.push(t5[l2]);
                  return s2;
                }(d);
              }
              ...
              function a(t4, e5) {
                if (!t4 || !e5 || t4.charAt(0) != e5.charAt(0)) return 0;
                for (var n4 = 0, r2 = Math.min(t4.length, e5.length), o2 = r2, i2 = 0; n4 < o2; ) t4.substring(i2, o2) == e5.substring(i2, o2) ? i2 = n4 = o2 : r2 = o2, o2 = Math.floor((r2 - n4) / 2 + n4);
                return o2;
              }
              function s(t4, e5) {
                if (!t4 || !e5 || t4.charAt(t4.length - 1) != e5.charAt(e5.length - 1)) return 0;
                for (var n4 = 0, r2 = Math.min(t4.length, e5.length), o2 = r2, i2 = 0; n4 < o2; ) t4.substring(t4.length - o2, t4.length - i2) == e5.substring(e5.length - o2, e5.length - i2) ? i2 = n4 = o2 : r2 = o2, o2 = Math.floor((r2 - n4) / 2 + n4);
                return o2;
              }
              var u = i;
              function c(t4, e5, n4) {
                for (var r2 = e5 + n4 - 1; r2 >= 0 && r2 >= e5 - 1; r2--) if (r2 + 1 < t4.length) {
              ...
              Object.create && (o.prototype = /* @__PURE__ */ Object.create(null), new o().__proto__ || (r = false)), l.prototype.eventNames = function() {
                ...
                for (e5 in t4 = this._events) n3.call(t4, e5) && o2.push(r ? e5.slice(1) : e5);
                ...
                if (e5) return !!o2;
                if (!o2) return [];
                if (o2.fn) return [o2.fn];
                for (var i2 = 0, l2 = o2.length, a = new Array(l2); i2 < l2; i2++) a[i2] = o2[i2].fn;
                return a;
                ...
                if (c.fn) {
                  ...
                  var h, p = c.length;
                  for (u = 0; u < p; u++) switch (c[u].once && this.removeListener(t4, c[u].fn, void 0, true), f) {
                    case 1:
                ...
                var l2 = r ? r + t4 : t4;
                if (!this._events[l2]) return this;
                if (!e5) return 0 == --this._eventsCount ? this._events = new o() : delete this._events[l2], this;
                var a = this._events[l2];
                if (a.fn) a.fn !== e5 || i2 && !a.once || n4 && a.context !== n4 || (0 == --this._eventsCount ? this._events = new o() : delete this._events[l2]);
                else {
                  for (var s = 0, u = [], c = a.length; s < c; s++) (a[s].fn !== e5 || i2 && !a[s].once || n4 && a[s].context !== n4) && u.push(a[s]);
              ...
              var O = (0, c.default)("quill:clipboard"), w = "__ql-matcher", x = [[Node.TEXT_NODE, M], [Node.TEXT_NODE, L], ["br", function(t4, e5) {
                ...
                for (var r2 = -1, o2 = t4.parentNode; !o2.classList.contains("ql-clipboard"); ) "list" === (s.default.query(o2) || {}).blotName && (r2 += 1), o2 = o2.parentNode;
                ...
                return function(t5, e6) {
                  ...
                  if ("string" == typeof t5) return this.container.innerHTML = t5.replace(/\>\r?\n +\</g, "><"), this.convert();
                  ...
                  if ("string" == typeof t5) this.quill.setContents(this.convert(t5), e6), this.quill.setSelection(0, u.default.sources.SILENT);
                  else {
              ...
              function P(t4) {
                if (0 === t4.childNodes.length) return false;
                var e5 = N(t4);
              ...
              function C(t4, e5) {
                ...
                } else "function" == typeof n4.formats && (e5 = j(e5, n4.blotName, n4.formats(t4)));
                return e5;
              }
              function L(t4, e5) {
              ...
              function M(t4, e5) {
                var n4 = t4.data;
                if ("O:P" === t4.parentNode.tagName) return e5.insert(n4.trim());
                if (0 === n4.trim().length && t4.parentNode.classList.contains("ql-clipboard")) return e5;
              ...
              var h = (0, s.default)("quill:toolbar"), p = function(t4) {
                function e5(t5, n4) {
                  ...
                  } else "string" == typeof i2.options.container ? i2.container = document.querySelector(i2.options.container) : i2.container = i2.options.container;
                ...
                return function(t5, e6) {
                  ...
                  if (n4) {
                    if (n4 = n4.slice("ql-".length), "BUTTON" === t5.tagName && t5.setAttribute("type", "button"), null == this.handlers[n4]) {
                      if (null != this.quill.scroll.whitelist && null == this.quill.scroll.whitelist[n4]) return void h.warn("ignoring attaching to disabled format", n4, t5);
                      if (null == l.default.query(n4)) return void h.warn("ignoring attaching to nonexistent format", n4, t5);
                    }
                    var o2 = "SELECT" === t5.tagName ? "change" : "click";
                    t5.addEventListener(o2, function(o3) {
                      var s2 = void 0;
                      if ("SELECT" === t5.tagName) {
                        if (t5.selectedIndex < 0) return;
                        var u2 = t5.options[t5.selectedIndex];
                        s2 = !u2.hasAttribute("selected") && (u2.value || false);
                      } else s2 = !t5.classList.contains("ql-active") && (t5.value || !t5.hasAttribute("value")), o3.preventDefault();
                      e6.quill.focus();
                      var c2 = e6.quill.selection.getRange(), f2 = r(c2, 1)[0];
                      if (null != e6.handlers[n4]) e6.handlers[n4].call(e6, s2);
                      else if (l.default.query(n4).prototype instanceof l.default.Embed) {
                        if (!(s2 = prompt("Enter " + n4))) return;
                      ...
                      } else e6.quill.format(n4, s2, a.default.sources.USER);
                      e6.update(f2);
                  ...
                  this.controls.forEach(function(n4) {
                    ...
                    if ("SELECT" === l2.tagName) {
                      var a2 = void 0;
                      if (null == t5) a2 = null;
                      else if (null == e6[i2]) a2 = l2.querySelector("option[selected]");
                    ...
                    } else if (null == t5) l2.classList.remove("ql-active");
                    ...
                    } else l2.classList.toggle("ql-active", null != e6[i2]);
                  });
                } }]), e5;
              }(u.default);
              function d(t4, e5, n4) {
              ...
              p.DEFAULTS = {}, p.DEFAULTS = { container: null, handlers: { clean: function() {
                ...
                } else this.quill.removeFormat(e5, a.default.sources.USER);
              ...
              var p = function(t4) {
                ...
                return f(e5, t4), r(e5, null, [{ key: "create", value: function(t5) {
                  ...
                  if (t5 instanceof h) o(e5.prototype.__proto__ || Object.getPrototypeOf(e5.prototype), "insertBefore", this).call(this, t5, n4);
                  else {
              ...
              var b = function(t4) {
                function e5(t5, n4) {
                  ...
                  return r2.quill.on(l.default.events.EDITOR_CHANGE, function(t6, e6, n5, o2) {
                    if (t6 === l.default.events.SELECTION_CHANGE) if (null != e6 && e6.length > 0 && o2 === l.default.sources.USER) {
                      ...
                      if (1 === i2.length) r2.position(r2.quill.getBounds(e6));
                      else {
                ...
                return d(e5, t4), o(e5, [{ key: "listen", value: function() {
                  ...
                  if (o2.style.marginLeft = "", 0 === n4) return n4;
        ...
        (function(t3) {
          ...
          function a(t4, e3) {
            if (l() < e3) throw new RangeError("Invalid typed array length");
            return s.TYPED_ARRAY_SUPPORT ? (t4 = new Uint8Array(e3)).__proto__ = s.prototype : (null === t4 && (t4 = new s(e3)), t4.length = e3), t4;
          }
          function s(t4, e3, n2) {
            if (!(s.TYPED_ARRAY_SUPPORT || this instanceof s)) return new s(t4, e3, n2);
            if ("number" == typeof t4) {
          ...
          function u(t4, e3, n2, r2) {
            ...
            return "undefined" != typeof ArrayBuffer && e3 instanceof ArrayBuffer ? function(t5, e4, n3, r3) {
              if (e4.byteLength, n3 < 0 || e4.byteLength < n3) throw new RangeError("'offset' is out of bounds");
              if (e4.byteLength < n3 + (r3 || 0)) throw new RangeError("'length' is out of bounds");
              ...
              if (e4) {
                if ("undefined" != typeof ArrayBuffer && e4.buffer instanceof ArrayBuffer || "length" in e4) return "number" != typeof e4.length || (r3 = e4.length) != r3 ? a(t5, 0) : h(t5, e4);
                if ("Buffer" === e4.type && i(e4.data)) return h(t5, e4.data);
              }
              var r3;
          ...
          function f(t4, e3) {
            if (c(e3), t4 = a(t4, e3 < 0 ? 0 : 0 | p(e3)), !s.TYPED_ARRAY_SUPPORT) for (var n2 = 0; n2 < e3; ++n2) t4[n2] = 0;
            return t4;
          }
          function h(t4, e3) {
            var n2 = e3.length < 0 ? 0 : 0 | p(e3.length);
            t4 = a(t4, n2);
            for (var r2 = 0; r2 < n2; r2 += 1) t4[r2] = 255 & e3[r2];
            return t4;
          }
          function p(t4) {
            if (t4 >= l()) throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x" + l().toString(16) + " bytes");
            return 0 | t4;
          }
          function d(t4, e3) {
            if (s.isBuffer(t4)) return t4.length;
          ...
          function y(t4, e3, n2) {
            ...
            for (t4 || (t4 = "utf8"); ; ) switch (t4) {
              ...
              case "utf-16le":
                return S(this, e3, n2);
              default:
                if (r2) throw new TypeError("Unknown encoding: " + t4);
          ...
          function b(t4, e3, n2, r2, o2) {
            ...
            if ("string" == typeof e3 && (e3 = s.from(e3, r2)), s.isBuffer(e3)) return 0 === e3.length ? -1 : g(t4, e3, n2, r2, o2);
            if ("number" == typeof e3) return e3 &= 255, s.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o2 ? Uint8Array.prototype.indexOf.call(t4, e3, n2) : Uint8Array.prototype.lastIndexOf.call(t4, e3, n2) : g(t4, [e3], n2, r2, o2);
          ...
          function g(t4, e3, n2, r2, o2) {
            ...
            if (o2) {
              var c2 = -1;
              for (i2 = n2; i2 < a2; i2++) if (u2(t4, i2) === u2(e3, -1 === c2 ? 0 : i2 - c2)) {
                if (-1 === c2 && (c2 = i2), i2 - c2 + 1 === s2) return c2 * l2;
              } else -1 !== c2 && (i2 -= i2 - c2), c2 = -1;
            } else for (n2 + s2 > a2 && (n2 = a2 - s2), i2 = n2; i2 >= 0; i2--) {
              for (var f2 = true, h2 = 0; h2 < s2; h2++) if (u2(t4, i2 + h2) !== u2(e3, h2)) {
                f2 = false;
                break;
              }
              if (f2) return i2;
          ...
          function O(t4, e3, n2, r2) {
            return z(function(t5) {
              for (var e4 = [], n3 = 0; n3 < t5.length; ++n3) e4.push(255 & t5.charCodeAt(n3));
              return e4;
            }(e3), t4, n2, r2);
          }
          ...
          function E(t4, e3, n2, r2) {
            return z(function(t5, e4) {
              for (var n3, r3, o2, i2 = [], l2 = 0; l2 < t5.length && !((e4 -= 2) < 0); ++l2) n3 = t5.charCodeAt(l2), r3 = n3 >> 8, o2 = n3 % 256, i2.push(o2), i2.push(r3);
              return i2;
          ...
          function A(t4, e3, n2) {
            ...
            return function(t5) {
              var e4 = t5.length;
              if (e4 <= j) return String.fromCharCode.apply(String, t5);
              var n3 = "", r3 = 0;
              for (; r3 < e4; ) n3 += String.fromCharCode.apply(String, t5.slice(r3, r3 += j));
              return n3;
            }(r2);
          }
          e2.Buffer = s, e2.SlowBuffer = function(t4) {
            ...
            if (!s.isBuffer(t4) || !s.isBuffer(e3)) throw new TypeError("Arguments must be Buffers");
            if (t4 === e3) return 0;
            for (var n2 = t4.length, r2 = e3.length, o2 = 0, i2 = Math.min(n2, r2); o2 < i2; ++o2) if (t4[o2] !== e3[o2]) {
              n2 = t4[o2], r2 = e3[o2];
              break;
            }
            ...
            if (!i(t4)) throw new TypeError('"list" argument must be an Array of Buffers');
            if (0 === t4.length) return s.alloc(0);
            var n2;
            if (void 0 === e3) for (e3 = 0, n2 = 0; n2 < t4.length; ++n2) e3 += t4[n2].length;
            var r2 = s.allocUnsafe(e3), o2 = 0;
            for (n2 = 0; n2 < t4.length; ++n2) {
              var l2 = t4[n2];
              if (!s.isBuffer(l2)) throw new TypeError('"list" argument must be an Array of Buffers');
            ...
            if (!s.isBuffer(t4)) throw new TypeError("Argument must be a Buffer");
            if (void 0 === e3 && (e3 = 0), void 0 === n2 && (n2 = t4 ? t4.length : 0), void 0 === r2 && (r2 = 0), void 0 === o2 && (o2 = this.length), e3 < 0 || n2 > t4.length || r2 < 0 || o2 > this.length) throw new RangeError("out of range index");
            if (r2 >= o2 && e3 >= n2) return 0;
            if (r2 >= o2) return -1;
            if (e3 >= n2) return 1;
            if (this === t4) return 0;
            for (var i2 = (o2 >>>= 0) - (r2 >>>= 0), l2 = (n2 >>>= 0) - (e3 >>>= 0), a2 = Math.min(i2, l2), u2 = this.slice(r2, o2), c2 = t4.slice(e3, n2), f2 = 0; f2 < a2; ++f2) if (u2[f2] !== c2[f2]) {
              i2 = u2[f2], l2 = c2[f2];
              break;
            }
            ...
            if (void 0 === e3) r2 = "utf8", n2 = this.length, e3 = 0;
            else if (void 0 === n2 && "string" == typeof e3) r2 = e3, n2 = this.length, e3 = 0;
            else {
            ...
            if ((void 0 === n2 || n2 > o2) && (n2 = o2), t4.length > 0 && (n2 < 0 || e3 < 0) || e3 > this.length) throw new RangeError("Attempt to write outside buffer bounds");
            r2 || (r2 = "utf8");
          ...
          function N(t4, e3, n2) {
            var r2 = "";
            n2 = Math.min(t4.length, n2);
            for (var o2 = e3; o2 < n2; ++o2) r2 += String.fromCharCode(127 & t4[o2]);
            return r2;
          }
          function T(t4, e3, n2) {
            var r2 = "";
            n2 = Math.min(t4.length, n2);
            for (var o2 = e3; o2 < n2; ++o2) r2 += String.fromCharCode(t4[o2]);
            return r2;
          }
          function P(t4, e3, n2) {
            var r2 = t4.length;
            (!e3 || e3 < 0) && (e3 = 0), (!n2 || n2 < 0 || n2 > r2) && (n2 = r2);
            for (var o2 = "", i2 = e3; i2 < n2; ++i2) o2 += U(t4[i2]);
            return o2;
          }
          function S(t4, e3, n2) {
            for (var r2 = t4.slice(e3, n2), o2 = "", i2 = 0; i2 < r2.length; i2 += 2) o2 += String.fromCharCode(r2[i2] + 256 * r2[i2 + 1]);
            return o2;
          }
          function q(t4, e3, n2) {
            if (t4 % 1 != 0 || t4 < 0) throw new RangeError("offset is not uint");
            if (t4 + e3 > n2) throw new RangeError("Trying to access beyond buffer length");
          }
          function C(t4, e3, n2, r2, o2, i2) {
            if (!s.isBuffer(t4)) throw new TypeError('"buffer" argument must be a Buffer instance');
            if (e3 > o2 || e3 < i2) throw new RangeError('"value" argument is out of bounds');
            if (n2 + r2 > t4.length) throw new RangeError("Index out of range");
          }
          function L(t4, e3, n2, r2) {
            e3 < 0 && (e3 = 65535 + e3 + 1);
            for (var o2 = 0, i2 = Math.min(t4.length - n2, 2); o2 < i2; ++o2) t4[n2 + o2] = (e3 & 255 << 8 * (r2 ? o2 : 1 - o2)) >>> 8 * (r2 ? o2 : 1 - o2);
          }
          function R(t4, e3, n2, r2) {
            e3 < 0 && (e3 = 4294967295 + e3 + 1);
            for (var o2 = 0, i2 = Math.min(t4.length - n2, 4); o2 < i2; ++o2) t4[n2 + o2] = e3 >>> 8 * (r2 ? o2 : 3 - o2) & 255;
          }
          ...
          s.prototype.slice = function(t4, e3) {
            ...
            if ((t4 = ~~t4) < 0 ? (t4 += r2) < 0 && (t4 = 0) : t4 > r2 && (t4 = r2), (e3 = void 0 === e3 ? r2 : ~~e3) < 0 ? (e3 += r2) < 0 && (e3 = 0) : e3 > r2 && (e3 = r2), e3 < t4 && (e3 = t4), s.TYPED_ARRAY_SUPPORT) (n2 = this.subarray(t4, e3)).__proto__ = s.prototype;
            else {
              var o2 = e3 - t4;
              n2 = new s(o2, void 0);
              for (var i2 = 0; i2 < o2; ++i2) n2[i2] = this[i2 + t4];
            }
            return n2;
          }, s.prototype.readUIntLE = function(t4, e3, n2) {
            t4 |= 0, e3 |= 0, n2 || q(t4, e3, this.length);
            for (var r2 = this[t4], o2 = 1, i2 = 0; ++i2 < e3 && (o2 *= 256); ) r2 += this[t4 + i2] * o2;
            return r2;
          }, s.prototype.readUIntBE = function(t4, e3, n2) {
            t4 |= 0, e3 |= 0, n2 || q(t4, e3, this.length);
            for (var r2 = this[t4 + --e3], o2 = 1; e3 > 0 && (o2 *= 256); ) r2 += this[t4 + --e3] * o2;
            return r2;
            ...
            t4 |= 0, e3 |= 0, n2 || q(t4, e3, this.length);
            for (var r2 = e3, o2 = 1, i2 = this[t4 + --r2]; r2 > 0 && (o2 *= 256); ) i2 += this[t4 + --r2] * o2;
            ...
            var o2 = 1, i2 = 0;
            for (this[e3] = 255 & t4; ++i2 < n2 && (o2 *= 256); ) this[e3 + i2] = t4 / o2 & 255;
            return e3 + n2;
          }, s.prototype.writeUIntBE = function(t4, e3, n2, r2) {
            (t4 = +t4, e3 |= 0, n2 |= 0, r2) || C(this, t4, e3, n2, Math.pow(2, 8 * n2) - 1, 0);
            var o2 = n2 - 1, i2 = 1;
            for (this[e3 + o2] = 255 & t4; --o2 >= 0 && (i2 *= 256); ) this[e3 + o2] = t4 / i2 & 255;
            return e3 + n2;
            ...
            var i2 = 0, l2 = 1, a2 = 0;
            for (this[e3] = 255 & t4; ++i2 < n2 && (l2 *= 256); ) t4 < 0 && 0 === a2 && 0 !== this[e3 + i2 - 1] && (a2 = 1), this[e3 + i2] = (t4 / l2 >> 0) - a2 & 255;
            return e3 + n2;
            ...
            for (this[e3 + i2] = 255 & t4; --i2 >= 0 && (l2 *= 256); ) t4 < 0 && 0 === a2 && 0 !== this[e3 + i2 + 1] && (a2 = 1), this[e3 + i2] = (t4 / l2 >> 0) - a2 & 255;
            return e3 + n2;
            ...
            if (n2 || (n2 = 0), r2 || 0 === r2 || (r2 = this.length), e3 >= t4.length && (e3 = t4.length), e3 || (e3 = 0), r2 > 0 && r2 < n2 && (r2 = n2), r2 === n2) return 0;
            ...
            var o2, i2 = r2 - n2;
            if (this === t4 && n2 < e3 && e3 < r2) for (o2 = i2 - 1; o2 >= 0; --o2) t4[o2 + e3] = this[o2 + n2];
            else if (i2 < 1e3 || !s.TYPED_ARRAY_SUPPORT) for (o2 = 0; o2 < i2; ++o2) t4[o2 + e3] = this[o2 + n2];
            else Uint8Array.prototype.set.call(t4, this.subarray(n2, n2 + i2), e3);
            return i2;
            ...
            if (e3 < 0 || this.length < e3 || this.length < n2) throw new RangeError("Out of range index");
            if (n2 <= e3) return this;
            var i2;
            if (e3 >>>= 0, n2 = void 0 === n2 ? this.length : n2 >>> 0, t4 || (t4 = 0), "number" == typeof t4) for (i2 = e3; i2 < n2; ++i2) this[i2] = t4;
            else {
              var l2 = s.isBuffer(t4) ? t4 : F(new s(t4, r2).toString()), a2 = l2.length;
              for (i2 = 0; i2 < n2 - e3; ++i2) this[i2 + e3] = l2[i2 % a2];
            }
            return this;
          };
          var D = /[^+\/0-9A-Za-z-_]/g;
          ...
          function H(t4) {
            return r.toByteArray(function(t5) {
              ...
              }(t5).replace(D, "")).length < 2) return "";
              for (; t5.length % 4 != 0; ) t5 += "=";
              return t5;
            }(t4));
          }
          function z(t4, e3, n2, r2) {
            for (var o2 = 0; o2 < r2 && !(o2 + n2 >= e3.length || o2 >= t4.length); ++o2) e3[o2 + n2] = t4[o2];
            return o2;
          }
        }).call(this, n(14));
      }, function(t2, e2, n) {
        ...
        e2.byteLength = function(t3) {
          ...
          for (n2 = 0; n2 < f; n2 += 4) e3 = o[t3.charCodeAt(n2)] << 18 | o[t3.charCodeAt(n2 + 1)] << 12 | o[t3.charCodeAt(n2 + 2)] << 6 | o[t3.charCodeAt(n2 + 3)], s2[c2++] = e3 >> 16 & 255, s2[c2++] = e3 >> 8 & 255, s2[c2++] = 255 & e3;
          ...
          for (var e3, n2 = t3.length, o2 = n2 % 3, i2 = [], l2 = 0, a2 = n2 - o2; l2 < a2; l2 += 16383) i2.push(c(t3, l2, l2 + 16383 > a2 ? a2 : l2 + 16383));
          1 === o2 ? (e3 = t3[n2 - 1], i2.push(r[e3 >> 2] + r[e3 << 4 & 63] + "==")) : 2 === o2 && (e3 = (t3[n2 - 2] << 8) + t3[n2 - 1], i2.push(r[e3 >> 10] + r[e3 >> 4 & 63] + r[e3 << 2 & 63] + "="));
          return i2.join("");
        };
        for (var r = [], o = [], i = "undefined" != typeof Uint8Array ? Uint8Array : Array, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", a = 0, s = l.length; a < s; ++a) r[a] = l[a], o[l.charCodeAt(a)] = a;
        function u(t3) {
          var e3 = t3.length;
        ...
        function c(t3, e3, n2) {
          for (var o2, i2, l2 = [], a2 = e3; a2 < n2; a2 += 3) o2 = (t3[a2] << 16 & 16711680) + (t3[a2 + 1] << 8 & 65280) + (255 & t3[a2 + 2]), l2.push(r[(i2 = o2) >> 18 & 63] + r[i2 >> 12 & 63] + r[i2 >> 6 & 63] + r[63 & i2]);
          return l2.join("");
        }
